...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    // Node detail
    'nodeDetail.title': '장면 상세',
    'nodeDetail.sceneTitle': '제목',
    'nodeDetail.characters': '등장인물',
    'nodeDetail.location': '배경',
    'nodeDetail.mood': '분위기 (작품 설정 재정의)',
    'nodeDetail.plotSummary': '줄거리 요약',
    'nodeDetail.plotPlaceholder': '이 장면에서 무슨 일이 일어나나요? 자세할수록 AI 초안의 품질이 높아집니다.',
    // Editor
  ...
  en: {
    ...
    'nodeDetail.title': 'Scene Detail',
    'nodeDetail.sceneTitle': 'Title',
    'nodeDetail.characters': 'Characters',
    'nodeDetail.location': 'Location',
    'nodeDetail.mood': 'Mood / Tone (overrides config)',
    'nodeDetail.plotSummary': 'Plot Summary',
    'nodeDetail.plotPlaceholder': 'What happens in this scene? The more detail you provide, the better the AI draft will be.',
