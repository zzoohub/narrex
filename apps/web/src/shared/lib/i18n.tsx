...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'settings.email': '이메일',
    'settings.profileImage': '프로필 이미지 URL',
    'settings.theme': '테마',
    ...
    'settings.deleteConfirmTitle': '정말로 계정을 삭제하시겠습니까?',
    'settings.deleteConfirmDescription': '{projects}개 프로젝트, {scenes}개 장면, {drafts}개 초고가 모두 삭제됩니다. 이 작업은 되돌릴 수 없습니다.',
    'settings.deleteConfirmPhrase': '계정 삭제',
    'settings.deleteConfirmPlaceholder': '"{phrase}"를 입력하세요',
    'settings.back': '돌아가기',
    'nav.settings': '설정',
  },
  en: {
    ...
    'settings.profileImage': 'Profile Image URL',
    ...
    'settings.deleteConfirmTitle': 'Are you sure you want to delete your account?',
    'settings.deleteConfirmDescription': 'This will permanently delete {projects} projects, {scenes} scenes, and {drafts} drafts. This cannot be undone.',
    'settings.deleteConfirmPhrase': 'delete my account',
    'settings.deleteConfirmPlaceholder': 'Type "{phrase}" to confirm',
