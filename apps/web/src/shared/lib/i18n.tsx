...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'creation.description': '아이디어를 설명하거나 메모, 줄거리, 등장인물 설명 등을 붙여넣으세요.',
    ...
    'creation.dropzone': '여기에 파일을 놓으세요 (.md, .txt)',
    ...
    'timeline.deleteSceneTitle': '씬을 삭제하시겠습니까?',
    'timeline.deleteSceneDescription': '이 씬과 관련된 초고가 모두 삭제됩니다. 이 작업은 되돌릴 수 없습니다.',
    'timeline.deleteTrackTitle': '트랙을 삭제하시겠습니까?',
    'timeline.deleteTrackDescription': '이 트랙을 삭제합니다.',
    'timeline.addScene': '씬 추가',
    'timeline.removeTrack': '트랙 삭제',
    'timeline.removeTrackDisabled': '트랙 삭제 (씬 존재)',
    // Shortcuts modal
    'shortcuts.title': '단축키',
    'shortcuts.zoomIn': '줌 인',
    'shortcuts.zoomOut': '줌 아웃',
    'shortcuts.fitToWindow': '전체 맞춤',
    'shortcuts.prevScene': '이전 씬',
    'shortcuts.nextScene': '다음 씬',
    'shortcuts.trackUp': '위 트랙으로 이동',
    'shortcuts.trackDown': '아래 트랙으로 이동',
    'shortcuts.duplicateScene': '씬 복제',
    'shortcuts.deleteScene': '씬 삭제',
    'shortcuts.cancelDrag': '드래그 취소',
    'shortcuts.horizontalScroll': '가로 스크롤',
    'shortcuts.zoom': '줌',
    'shortcuts.showShortcuts': '단축키 보기',
    // Characters
  ...
  en: {
    ...
    'creation.dropzone': 'Drop a file here (.md, .txt)',
    ...
    'timeline.deleteSceneTitle': 'Delete this scene?',
    'timeline.deleteSceneDescription': 'All drafts for this scene will be removed. This cannot be undone.',
    'timeline.deleteTrackTitle': 'Delete this track?',
    'timeline.deleteTrackDescription': 'This track will be deleted.',
    'timeline.addScene': 'Add Scene',
    'timeline.removeTrack': 'Remove Track',
    'timeline.removeTrackDisabled': 'Remove Track (has scenes)',
    // Shortcuts modal
    'shortcuts.title': 'Keyboard Shortcuts',
    'shortcuts.zoomIn': 'Zoom in',
    'shortcuts.zoomOut': 'Zoom out',
    'shortcuts.fitToWindow': 'Fit to window',
    'shortcuts.prevScene': 'Previous scene',
    'shortcuts.nextScene': 'Next scene',
    'shortcuts.trackUp': 'Move to track above',
    'shortcuts.trackDown': 'Move to track below',
    'shortcuts.duplicateScene': 'Duplicate scene',
    'shortcuts.deleteScene': 'Delete scene',
    'shortcuts.cancelDrag': 'Cancel drag',
    'shortcuts.horizontalScroll': 'Horizontal scroll',
    'shortcuts.zoom': 'Zoom',
    'shortcuts.showShortcuts': 'Keyboard shortcuts',
